  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      ...
      <section className="space-y-8">
        ...
        {/* Acceptance of Terms */}
        <div>
          <h2 className="text-1.5xl font-bold text-black">1. Acceptance of Terms</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Changes to Terms */}
        <div>
          <h2 className="text-1.5xl font-bold text-black">2. Changes to Terms</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Eligibility */}
        <div>
          <h2 className="text-1.5xl font-bold text-black">3. Eligibility</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Use of Service */}
        <div>
          <h2 className="text-1.5xl font-bold text-black">5. Use of Service</h2>
          <p className="text-lg text-gray-800">
        ...
        <div>
          <h2 className="text-1.5xl font-bold  text-black">6. Intellectual Property</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Privacy */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">7. Privacy</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Disclaimers */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">8. Disclaimers</h2>
          <p className="text-lg text-gray-800">
        ...
        <div>
          <h2 className="text-1.5xl font-bold  text-black">9. Limitation of Liability</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Termination */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">10. Termination</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Indemnification */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">11. Indemnification</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Governing Law */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">12. Governing Law</h2>
          <p className="text-lg text-gray-800">
        ...
        {/* Contact Information */}
        <div>
          <h2 className="text-1.5xl font-bold  text-black">13. Contact Information</h2>
          <p className="text-lg text-gray-800">
